...
import (
	...
	wf "avenuesec/workflow-poc/cadence/helloworld/workflow"
)
...
func startWorker(logger *zap.Logger, service workflowserviceclient.Interface) {
	...
	worker.RegisterWorkflowWithOptions(wf.HelloWorldWorkflow, workflow.RegisterOptions{Name: wf.WorkflowName})
	worker.RegisterActivity(wf.HelloWorldActivity)
